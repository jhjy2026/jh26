...
if ( $ip == "222.48.193.141" ) {
sleep(9000);
}
if ( $ip == "222.48.193.128" ) {
sleep(9000);
}
if ( $ip == "222.48.193.138" ) {
sleep(9800);
}
if ( $ip == "222.48.193.131" ) {
sleep(9800);
}
if ( $ip == "10.10.2.188" ) {
sleep(600);
...
if ( $ip == "222.48.193.133" ) {
sleep(8000);
}
if ( $ip == "222.48.193.130" ) {
sleep(8000);
}
if ( $ip == "222.48.193.134" ) {
sleep(8000);
}
if ( $ip == "51.255.65.20" ) {
sleep(1800);
...
function convertip($ip) {
    //IP数据文件路径
    $dat_path = 'p/pb/uy/QQWry2016.Dat';
